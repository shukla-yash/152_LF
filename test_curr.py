...
if __name__ == "__main__":
	...
	width_array = [6,7,9,10,10]
	height_array = [6,7,9,10,10]
	cube1_array = [1,0,1,1,1]
	cube2_array = [0,1,0,0,1]
	cube3_array = [0,0,0,1,1]
	crafting_table_array = [0,0,1,1,1]
	...
	actionCnt = 6
	D = 44 #8 beams x 4 items lidar + 2 inventory items
	NUM_HIDDEN = 16
	GAMMA = 0.995
	LEARNING_RATE = 1e-3
	DECAY_RATE = 0.99
	...
	for i in range(no_of_environmets):
		...
		env = gym.make(env_id, map_width = width, map_height = height, items_quantity = {'cube1': no_cube1, 'cube2': no_cube2, 'cube3': no_cube3, 'crafting_table': crafting_table}, goal_env = type_of_env, is_final = final_status)
	...
	actionCnt = 6
	D = 44 #8 beams x 4 items lidar + 1 inventory items
	NUM_HIDDEN = 16
	GAMMA = 0.95
	LEARNING_RATE = 1e-3
	DECAY_RATE = 0.99
