...
class NovelGridworldV0Env(gym.Env):
    ...
    def __init__(self, map_width=None, map_height=None, items_id=None, items_quantity=None, goal_env = None, is_final = False):
        ...
        self.items = ['wall', 'cube1', 'cube2', 'cube3', 'crafting_table']
        ...
        self.items_quantity = {'cube1': 1, 'cube2': 1, 'cube3': 1, 'crafting_table': 1}
        ...
        self.items_lidar = ['wall', 'crafting_table', 'cube1', 'cube2', 'cube3']
        self.items_id_lidar = self.set_items_id(self.items_lidar)
        self.low = np.array([0] * (len(self.items_lidar) * self.num_beams) + [0] * 1 + [0] * 3 )
        self.high = np.array([self.max_beam_range] * (len(self.items_lidar) * self.num_beams) + [3] * 1 + [3]*3)  # maximum 5 trees present in the environment
        ...
        self.items_released = [0,0,0]
        self.target_dropped_items = self.items_quantity['cube1'] + self.items_quantity['cube2'] + self.items_quantity['cube3']
        if self.items_quantity['cube1'] == 1 and self.items_quantity['cube2'] == 0 and self.items_quantity['cube3'] == 0:
            self.target_release_order = [1]
        if self.items_quantity['cube1'] == 0 and self.items_quantity['cube2'] == 1 and self.items_quantity['cube3'] == 0:
            self.target_release_order = [2]
        if self.items_quantity['cube1'] == 0 and self.items_quantity['cube2'] == 0 and self.items_quantity['cube3'] == 1:
            self.target_release_order = [3]
        if self.items_quantity['cube1'] == 0 and self.items_quantity['cube2'] == 1 and self.items_quantity['cube3'] == 1:
            self.target_release_order = [2,3]
        if self.items_quantity['cube1'] == 1 and self.items_quantity['cube2'] == 1 and self.items_quantity['cube3'] == 0:
            self.target_release_order = [1,2]
        if self.items_quantity['cube1'] == 1 and self.items_quantity['cube2'] == 0 and self.items_quantity['cube3'] == 1:
            self.target_release_order = [1,3]
        if self.items_quantity['cube1'] == 1 and self.items_quantity['cube2'] == 1 and self.items_quantity['cube3'] == 1:
            self.target_release_order = [1,2,3]
    ...
    def get_observation(self):
        ...
        observation = lidar_signals + [self.current_pickup_item] + self.items_released
    ...
    def step(self, action):
        ...
        # PickUp
            ...
            if self.block_in_front_str == 'cube1' or self.block_in_front_str == 'cube2' or self.block_in_front_str == 'cube3':
                if self.current_pickup_state == 0:
                    ...
                    elif self.block_in_front_str == 'cube3':
                        self.current_pickup_item = 3
